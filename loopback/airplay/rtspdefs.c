...
const gchar *rtsp_headers[] = {
  ...
  /* RAOP-specific */
  "Client-Instance",            /* Client-Instance      R      opt.      all */
  "Apple-Challenge",            /* Apple-Challenge      R      opt.      all */
  "Apple-Response",             /* Apple-Response       r      opt.      all */
  "Audio-Jack-Status",          /* Audio-Jack-Status    r      opt.      all */
  NULL
};
