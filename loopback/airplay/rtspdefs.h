...
/* RAOP-specific */
  RTSP_HDR_CLIENT_INSTANCE,     /* Client-Instance      R      opt.      all */
  RTSP_HDR_APPLE_CHALLENGE,     /* Apple-Challenge      R      opt.      all */
  RTSP_HDR_APPLE_RESPONSE,      /* Apple-Response       r      opt.      all */
  RTSP_HDR_AUDIO_JACK_STATUS,   /* Audio-Jack-Status    r      opt.      all */
} RTSPHeaderField;
